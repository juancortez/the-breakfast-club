...
export function Chapter({ book, gradient = 'bg-gradient-to-r to-emerald-600 from-sky-400', children }: ChapterProps) {
  return (
    <article>
      <h2 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-4xl">
        <span className={`text-transparent bg-clip-text ${gradient}`}>{book}</span>
      </h2>

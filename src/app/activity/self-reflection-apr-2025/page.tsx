    ...
    <div className="flex flex-col">
      ...
      <div>
        <p className="text-gray-500 dark:text-gray-400 font-small">
          ...
          <AppLink
            href="/topic/act-like-men/discussion/truly-as-good-as-it-gets"
            content="Truly - As good as it gets"
          />{" "}
          chapter.
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 mt-4 justify-center">
        <div className="h-dvh border-r-2 border-gray-100">
          <p className="p-4 font-medium min-h-64 md:min-h-1">
            Imagine if a light were shone on your character—what leaks would be
            revealed?
          </p>
          <hr />
        </div>
        <div className="border-r-2 border-gray-100">
          <p className="p-4 font-medium min-h-64 md:min-h-1">
            List those areas most needing attention as you pursue quality
            manhood.
          </p>
          <hr />
        </div>
        <div>
          <p className="p-4 font-medium min-h-64 md:min-h-1">
            Name a specific action you can take today to advance your pursuit of
            quality manhood.
          </p>
          <hr />
        </div>
